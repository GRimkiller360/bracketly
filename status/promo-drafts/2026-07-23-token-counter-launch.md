...
I use OpenAI's API often enough that I'm regularly guessing at token counts before I hit send — "is this prompt going to blow the context window" is a dumb thing to find out from an error response. So I added a [GPT Token Counter](https://bracketly.pages.dev/tools/token-counter/) to Bracketly, my free client-side dev tools site, and it turned into a smaller, more interesting problem than I expected.
...
Free, no signup, runs entirely in your browser: [bracketly.pages.dev/tools/token-counter](https://bracketly.pages.dev/tools/token-counter/).
